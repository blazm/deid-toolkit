...
from cleanir.cleanir.blocks import *
from cleanir.cleanir.losses import *
from cleanir.cleanir.tools.named_logs import named_logs
...
class Cleanir:
    ...
    def load_models(self, model_path):
        ...
        self.__encoder = load_model(encoder_path)
    ...
    def train(self, res_path, data_generator, n_epochs=300):
        ...
        for epoch in range(1, n_epochs + 1):
            for X, c in tqdm(data_generator):
                ...
                tb_callback.on_epoch_end(batch_step)
                batch_step += 1
