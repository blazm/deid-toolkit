...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # 2021 archive: dict -> ['model'] (DataParallel); 2023 archive: raw module
        _arc_mod = netArc_checkpoint['model'] if isinstance(netArc_checkpoint, dict) else netArc_checkpoint
        self.netArc = _arc_mod.module if hasattr(_arc_mod, "module") else _arc_mod
