...
PATH_TO_MODEL_WEIGHTS  = str(SCRIPT_DIR / "weights" / "checkpoint_step_79999_gpu_0.pt")
...
def main():
    ...
    for i, (name_a, name_b, gt_label) in enumerate(tqdm(zip(names_a, names_b, ground_truth_binary_labels), total=len(names_a), desc=f"swinface | {dataset_name}-{technique_name}")):
