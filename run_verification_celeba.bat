...
set GENUINE=%ROOT%/datasets/pairs/celeba-test_aligned_genuine_pairs.txt
set IMPOSTOR=%ROOT%/datasets/pairs/celeba-test_aligned_impostor_pairs.txt
set LOGS=%ROOT%/logs
...
python deid/evaluation/arcface.py ^
    ...
    --save_path "%ROOT%/results/blur/celeba-test_aligned/arcface.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
python deid/evaluation/arcface.py ^
    ...
    --genuine_pairs_filepath "%GENUINE%" ^
    --impostor_pairs_filepath "%IMPOSTOR%" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/arcface.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
python deid/evaluation/adaface_optimized.py ^
    ...
    --genuine_pairs_filepath "%GENUINE%" ^
    --impostor_pairs_filepath "%IMPOSTOR%" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/adaface_optimized.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
python deid/evaluation/adaface_optimized.py ^
    ...
    --genuine_pairs_filepath "%GENUINE%" ^
    --impostor_pairs_filepath "%IMPOSTOR%" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/adaface_optimized.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
python deid/evaluation/swinface.py ^
    ...
    --genuine_pairs_filepath "%GENUINE%" ^
    --impostor_pairs_filepath "%IMPOSTOR%" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/swinface.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
python deid/evaluation/swinface.py ^
    ...
    --genuine_pairs_filepath "%GENUINE%" ^
    --impostor_pairs_filepath "%IMPOSTOR%" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/swinface.csv" ^
    --dir_to_log "%LOGS%" ^
    --root_dir "%ROOT%"
...
echo Visuals:    %ROOT%/results/viz/celeba-test_aligned_{swinface,adaface}/
pause
