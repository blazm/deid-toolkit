...
python deid/evaluation/dan.py ^
    ...
    --save_path "%ROOT%/results/blur/celeba-test_aligned/dan.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/dan.py ^
    ...
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/dan.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_GD.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/blur/celeba-test_aligned" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/deepface_gender.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_GD.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/pixelize/celeba-test_aligned" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/deepface_gender.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_expression.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/blur/celeba-test_aligned" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/deepface_expression.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_expression.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/pixelize/celeba-test_aligned" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/deepface_expression.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_age.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/blur/celeba-test_aligned" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/deepface_age.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_age.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/pixelize/celeba-test_aligned" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/deepface_age.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_race.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/blur/celeba-test_aligned" ^
    --save_path "%ROOT%/results/blur/celeba-test_aligned/deepface_race.csv" ^
    --dir_to_log "%LOGS%"
...
python deid/evaluation/deepface_race.py ^
    "%ALIGNED%" ^
    "%ROOT%/datasets/deidentified/pixelize/celeba-test_aligned" ^
    --save_path "%ROOT%/results/pixelize/celeba-test_aligned/deepface_race.csv" ^
    --dir_to_log "%LOGS%"
